...
<body>
                ...
                <ul class="navbar-nav navbar-right">
                        ...
                        <div class="dropdown-menu dropdown-list dropdown-menu-right pullDown">
                            ...
                            <div class="dropdown-list-content dropdown-list-message">
                                <a href="#" class="dropdown-item"> <span
                                        ...
                                        <img alt="image" src="{{ asset('adminAssets/img/users/user-2.png') }}"
                                        ...
                                        class="dropdown-item-avatar text-white">
                                        <img alt="image" src="{{ asset('adminAssets/img/users/user-5.png') }}"
                                            class="rounded-circle">
                                        ...
                                        class="dropdown-item-avatar text-white">
                                        <img alt="image" src="{{ asset('adminAssets/img/users/user-4.png') }}"
                                            class="rounded-circle">
                                        ...
                                        class="dropdown-item-avatar text-white">
                                        <img alt="image" src="{{ asset('adminAssets/img/users/user-3.png') }}"
                                            class="rounded-circle">
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown"
                        ...
                        <div class="dropdown-menu dropdown-menu-right pullDown">
                            ...
                            <a href="{{ route('profile.update') }}" class="dropdown-item has-icon"> <i
                                    class="far
										fa-user"></i> Profile
                            </a> <a href="timeline.html" class="dropdown-item has-icon"> <i class="fas fa-bolt"></i>
                                Activities
                            </a> <a href="{{ route('profile.edit') }}" class="dropdown-item has-icon"> <i
                                    class="fas fa-cog"></i>
                                Settings
                            </a>
            ...
            <div class="main-sidebar
                ...
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="index.html"> <img alt="image" src="{{ asset('adminAssets/img/logo.png') }}"
                                class="header-logo" />
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="widget-chart.html">Chart Widgets</a>
                                </li>
                                <li><a class="nav-link" href="widget-data.html">Data Widgets</a>
                                </li>
                            </ul>
                        </li>
                        <li class="dropdown">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="nav-link" href="media-object.html">Media Object</a>
                                </li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="nav-link" href="sweet-alert.html">Sweet Alert</a>
                                </li>
                                <li><a class="nav-link" href="toastr.html">Toastr</a></li>
                                <li><a class="nav-link" href="empty-state.html">Empty State</a>
                                </li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="nav-link" href="form-wizard.html">Form Wizard</a>
                                </li>
                            </ul>
                        </li>
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="basic-table.html">Basic Tables</a>
                                </li>
                                <li><a class="nav-link" href="advance-table.html">Advanced
                                        Table</a></li>
                                <li><a class="nav-link" href="datatables.html">Datatable</a></li>
                                <li><a class="nav-link" href="export-table.html">Export Table</a>
                                </li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="nav-link" href="chart-apexchart.html">apexchart</a>
                                </li>
                                <li><a class="nav-link" href="chart-echart.html">eChart</a></li>
                                <li><a class="nav-link" href="chart-chartjs.html">Chartjs</a></li>
                                <li><a class="nav-link" href="chart-sparkline.html">Sparkline</a>
                                </li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="nav-link" href="icon-material.html">Material
                                        Design</a></li>
                                <li><a class="nav-link" href="icon-ionicons.html">Ion Icons</a>
                                </li>
                                <li><a class="nav-link" href="icon-feather.html">Feather Icons</a>
                                </li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="nav-link" href="owl-carousel.html">Owl Carousel</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="dropdown">
                            <a href="#" class="menu-toggle nav-link has-dropdown"><i
                                    ...
                                    Pages</span></a>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="create-post.html">Create Post</a>
                                </li>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="dropdown">
                                            <a href="#" class="has-dropdown">Child Menu
                                                2</a>
                                            <ul class="dropdown-menu">
                                                <li><a href="#">Child Menu 1</a></li>
                                        ...
                                        <div class="row ">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                                                <div class="banner-img">
                                                    <img src="{{ asset('adminAssets/img/banner/1.png') }}"
                                                        alt="">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="card-statistic-4">
                                    <div class="align-items-center justify-content-between">
                                        <div class="row ">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                                                <div class="banner-img">
                                                    <img src="{{ asset('adminAssets/img/banner/2.png') }}"
                                                        alt="">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="card-statistic-4">
                                    <div class="align-items-center justify-content-between">
                                        <div class="row ">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                                                <div class="banner-img">
                                                    <img src="{{ asset('adminAssets/img/banner/3.png') }}"
                                                        alt="">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="card-statistic-4">
                                    <div class="align-items-center justify-content-between">
                                        <div class="row ">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                                                <div class="banner-img">
                                                    <img src="{{ asset('adminAssets/img/banner/4.png') }}"
                                                        alt="">
                                                </div>
                                            </div>
                                        </div>
    ...
    <!-- JS Libraies -->
    <script src="{{ asset('adminAssets/bundles/apexcharts/apexcharts.min.js') }}"></script>
    <!-- Page Specific JS File -->
    <script src="{{ asset('adminAssets/js/page/index.js') }}"></script>
    <!-- Template JS File -->
